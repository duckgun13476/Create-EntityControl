...
public class Config {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> BLOCKS_LIMIT;
    ...
    private static final ModConfigSpec.BooleanValue KEEP_STRUCTURE_AT_FIRST =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.IntValue KEEP_STRUCTURE_REFRESH_TIME =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.BooleanValue DEBUG_BLOCK_ENTITY_PROBLEM =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.BooleanValue MINECART_PROTECTION =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.IntValue BLOCK_ENTITY_MAX_Y_LENGTH =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> BLOCKS_UNCRUSHABLE_IGNORE =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.ConfigValue<List<? extends String>> BLOCKS_IGNORE =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_BLOCK_EXPERIMENT_PARA =
            BUILDER.comment("--------------------------------------------------------------------------")
    ...
    private static final ModConfigSpec.IntValue BLOCK_ENTITY_MAX_STABILIZE_COUNT =
            BUILDER.comment("--------------------------------------------------------------------------")
